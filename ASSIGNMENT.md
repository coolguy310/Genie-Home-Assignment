...
Please keep in mind that although we accept solutions in TypeScript and Java, the core backend programming language at Genie is Python. We use the same frameworks as the ones selected for the assignment, so you will be expected to learn them if you decide to work for us.
